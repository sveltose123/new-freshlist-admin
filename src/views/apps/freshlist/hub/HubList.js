...
import { Edit, Trash2, ChevronDown, Clock } from "react-feather";
                    ...
                    return (
                        <div className="actions cursor-pointer">
                            <Edit
                                ...
                                size="25px"
                                color="blue"
                                onClick={() => history.push(`/app/freshlist/hub/editHub/${params.data._id}`)}
                            />
                            <Clock
                                className="mr-50"
                                size="25px"
                                color="blue"
                                onClick={() => history.push(`/app/freshlist/hub/time/${params.data._id}`)}
                            />
                            <Trash2
                                className="mr-50"
                                size="25px"
                            ...
                            <Row className="m-2">
                                ...
                                <Col>
                                    <Route render={({ history }) => (
                                        <Button
                                            className="btn btn-danger float-right"
                                            onClick={() => history.push("/app/freshlist/hub/AddHub")}
                                        >
                                            Add New
                                        </Button>
                                    )}
