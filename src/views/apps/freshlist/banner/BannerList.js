          ...
          return (
            <div className="actions cursor-pointer">
              <Eye
                ...
                color="green"
                onClick={() =>
                  history.push(`/app/freshlist/banner/viewBanner/${params.data._id}`)
                }
              />
              <Edit
                className="mr-50"
                size="25px"
                color="blue"
                onClick={() => history.push("/app/freshlist/banner/editBanner/${params.data._id}")}
              />
              <Trash2
                className="mr-50"
                size="25px"
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() => history.push("/app/freshlist/banner/addBanner")}
                  >
                    Add Banner
                  </Button>
                </Col>
