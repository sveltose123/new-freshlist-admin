...
class SubCategoryList extends React.Component {
                    ...
                    return (
                        <div className="actions cursor-pointer">
                            <Edit
                                ...
                                size="25px"
                                color="blue"
                                onClick={() => history.push(`/app/freshlist/subcategory/editSubCategory/${params.data._id}`)}
                            />
                            <Trash2
                                className="mr-50"
                                size="25px"
    ...
    async componentDidMount() {
        ...
        await axiosConfig.get(`/admin/sub_viewonedata/${id}`)
            .then((response) => {
    ...
    async runthisfunction(id) {
        console.log(id);
        await axiosConfig.get(`/admin/del_subcategory/${id}`).then(
            (response) => {
                            ...
                            <Row className="m-2">
                                ...
                                <Col>
                                    <Route render={({ history }) => (
                                        <Button
                                            className="btn btn-danger float-right"
                                            onClick={() => history.push("/app/freshlist/subcategory/addSubCategory")}
                                        >
                                            Add New
                                        </Button>
                                    )}
