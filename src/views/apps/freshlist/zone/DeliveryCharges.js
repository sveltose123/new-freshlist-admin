                    ...
                    return (
                        <div className="actions cursor-pointer">
                            <Edit
                                ...
                                size="25px"
                                color="blue"
                                onClick={() => history.push(`/app/freshlist/zone/editDeliveryCharges/${params.data._id}`)}
                            />
                            <Trash2
                                className="mr-50"
                                size="25px"
                            ...
                            <Row className="m-2">
                                ...
                                <Col>
                                    <Button style={{ marginRight: '-15rem' }}
                                        ...
                                        onClick={() => history.push("/app/freshlist/zone/DeliveryChargesList")}
                                    >
                                        Back
                                    </Button>
                                </Col>
                                <Col>
                                    <Route render={({ history }) => (
                                        <Button
                                            className="btn btn-danger float-right"
                                            onClick={() => history.push("/app/freshlist/zone/AddDeliveryCharges")}
                                        >
                                            Add New
                                        </Button>
                                    )}
