...
class AddBillableExpenseDetails extends React.Component {
  // constructor(props) {
  //   super(props);
  //   this.state = {
  //     description: "",
        ...
        <Row className="m-2">
          ...
          <Col>
            <Button
              ...
              onClick={() => history.push("/app/purchasesAndExpenses/billableExpenseDetails/billableExpenseDetails")}
            >
              Back
            </Button>
          </Col>
...
export default AddBillableExpenseDetails;
