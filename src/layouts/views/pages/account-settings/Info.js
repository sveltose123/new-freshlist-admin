...
const languages = [
  { value: "english", label: "English", color: "#1877f2" },
  { value: "french", label: "French", color: "#1877f2" },
  { value: "spanish", label: "Spanish", color: "#1877f2" },
  { value: "russian", label: "Russian", color: "#1877f2" },
  { value: "italian", label: "Italian", color: "#1877f2" }
]

const colourStyles = {
  control: styles => ({ ...styles, backgroundColor: "white" }),
  option: (styles, { data, isDisabled, isFocused, isSelected }) => {
    const color = data.color ? chroma(data.color) : "#1877f2"
    return {
      ...styles,
      ...
      ":active": {
        ...styles[":active"],
        backgroundColor: !isDisabled && (isSelected ? data.color : "#1877f2")
      }
    }
  },
  ...
  multiValueLabel: (styles, { data }) => ({
    ...styles,
    color: data.color ? data.color : "#1877f2"
  }),
  multiValueRemove: (styles, { data }) => ({
    ...styles,
    color: data.color,
    ":hover": {
      backgroundColor: data.color ? data.color : "#1877f2",
      color: "white"
    }
  })
}
